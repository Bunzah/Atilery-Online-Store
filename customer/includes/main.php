...
<body>
  ...
  <header class="page-header">
    <!-- topline -->
    <div class="page-header__topline" style="background-color: #2c0e4b;">
...
?>
        ...
        <div class="basket">
          <a href="../cart.php" class="btn btn--basket" style="background-color: #00c8c8; color: #8233b7;" >
      ...
      <div class="container clearfix">
        ...
        <div class="logo">
          <a class="logo__link" href="../index.php">
            <img class="logo__img" src="/Applications/XAMPP/xamppfiles/htdocs/Atilery Online Store/images" alt="" width="237" height="19">
          </a>
        </div>
