  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> AT Atilery
      </div>
      <p class="nero__text">
      </p>
    </div>
...
$password_encrypted = sha1($c_pass.$salt);
...
$from = "gooutfit.6@gmail.com";

$message = "

<h2>
Email Confirmation By GoOutfit $c_name
</h2>
...
$insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_country,customer_city,customer_contact,customer_address,customer_image,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$password_encrypted','$c_country','$c_city','$c_contact','$c_address','$c_image','$c_ip','$customer_confirm_code')";
